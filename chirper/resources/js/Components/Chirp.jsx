                    ...
                    <div>
                        ...
                        {chirp.media_path && (
                            <div className="mt-4">
                                ...
                                chirp.media_path.endsWith('.mov') ? (
                                    <video controls className="w-full rounded-lg">
                                        <source
                                            src={`/storage/${chirp.media_path}`}
                                            type="video/mp4"
                                        />
                        ...
                        {chirp.hashtags && (
                            <div className="mt-2">
                                <p className="text-blue-500">
                                    {chirp.hashtags.split(',').map((tag, index) => (
        ...
        <div className="p-6 flex space-x-2">
            ...
            >
                <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.04  2 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"
                />
            </svg>
            <div className="flex-1">
                {/* Header */}
                ...
                {editing ? (
                    ...
                    <div>
                        {/* Menampilkan konten HTML dari WYSIWYG */}
                        <div
